...
export const DIRETRIZES_DE_MARCA = [
  ...
  '',
  'COLOR — respect this order of dominance, it is what makes the brand read as',
  ...
  `2. Deep green ${PALETA.verdeProfundo} is the one strong colour — painted structure,`,
  '   large surfaces, uniforms, vehicles.',
  `3. Cream ${PALETA.creme}, mist grey ${PALETA.cinzaNevoa} and eucalyptus ${PALETA.eucalipto}`,
  '   for secondary surfaces and calm areas.',
  `4. Neon lime ${PALETA.verdeNeon} appears on exactly ONE element, and small: a single`,
